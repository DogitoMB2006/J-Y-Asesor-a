    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative mb-16">
            ...
            >
              {testimonials.map((testimonial, index) => (
                <div key={index} className="w-full flex-shrink-0 px-2 sm:px-4">
                  <div className="relative bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl lg:rounded-3xl p-6 sm:p-8 lg:p-12 shadow-2xl mx-auto max-w-4xl overflow-hidden">
                 
                    <div className="absolute top-0 right-0 w-20 sm:w-32 h-20 sm:h-32 bg-gradient-to-br from-yellow-400/20 to-transparent rounded-full blur-2xl"></div>
                    ...
                    <div className="text-yellow-400 text-4xl sm:text-5xl lg:text-6xl mb-4 sm:mb-6 text-center leading-none">
                      "
                    </div>
                    
                
                    <blockquote className="text-white text-base sm:text-lg lg:text-xl leading-relaxed text-center mb-6 sm:mb-8 font-light italic relative px-2">
                      {testimonial.text}
                    </blockquote>
                    

                    <div className="flex justify-center space-x-1 mb-6 sm:mb-8">
                      {[...Array(testimonial.rating)].map((_, i) => (
                        <svg 
                          key={i} 
                          className="w-5 h-5 sm:w-6 sm:h-6 text-yellow-400 fill-current transform hover:scale-110 transition-transform duration-200" 
                          viewBox="0 0 20 20"
                        >
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center space-y-3 sm:space-y-0 sm:space-x-4">
                      ...
                      <div className={`w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br ${testimonial.bgColor} rounded-full flex items-center justify-center text-white font-bold text-base sm:text-lg shadow-lg`}>
                        {testimonial.avatar}
                      </div>
                      ...
                      <div className="text-center sm:text-left">
                        ...
                        <div className="text-gray-400 text-xs flex items-center justify-center sm:justify-start mt-1">
                    ...
                    <div className="absolute top-4 right-4 sm:top-6 sm:right-6 bg-green-500/90 backdrop-blur-sm rounded-full px-2 py-1 sm:px-3 sm:py-1 text-white text-xs font-semibold flex items-center">
                      ...
                      <span className="hidden sm:inline">Visa Aprobada</span>
          ...
          <button 
            onClick={prevSlide}
            className="hidden md:flex absolute left-2 lg:left-0 top-1/2 -translate-y-1/2 lg:-translate-x-4 bg-white/10 hover:bg-white/20 backdrop-blur-sm border border-white/30 rounded-full p-3 lg:p-4 transition-all duration-300 group hover:scale-110 items-center justify-center"
          >
            <svg className="w-5 h-5 lg:w-6 lg:h-6 text-white group-hover:text-yellow-400 transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button 
            onClick={nextSlide}
            className="hidden md:flex absolute right-2 lg:right-0 top-1/2 -translate-y-1/2 lg:translate-x-4 bg-white/10 hover:bg-white/20 backdrop-blur-sm border border-white/30 rounded-full p-3 lg:p-4 transition-all duration-300 group hover:scale-110 items-center justify-center"
          >
            <svg className="w-5 h-5 lg:w-6 lg:h-6 text-white group-hover:text-yellow-400 transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {/* User selection thumbnails - More compact on mobile */}
        <div className="flex justify-center space-x-2 sm:space-x-4 mb-12 overflow-x-auto pb-4 px-4">
          {testimonials.map((testimonial, index) => (
            <button
              key={index}
              onClick={() => goToSlide(index)}
              className={`flex-shrink-0 p-2 sm:p-4 rounded-xl sm:rounded-2xl transition-all duration-300 border-2 ${
                index === currentIndex 
            ...
            >
              <div className="flex items-center space-x-2 sm:space-x-3">
                <div className={`w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br ${testimonial.bgColor} rounded-full flex items-center justify-center text-white font-bold text-xs sm:text-sm`}>
                  {testimonial.avatar}
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-8 mb-12">
          ...
          <div className="text-center bg-white/5 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-white/10">
            ...
            <div className="text-gray-300 text-sm sm:text-base">Tasa de Aprobación</div>
          </div>
          <div className="text-center bg-white/5 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-white/10">
            <div className="text-3xl sm:text-4xl font-bold text-yellow-400 mb-2">10+</div>
        ...
        <div className="text-center px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center max-w-lg mx-auto">
            <a 
              ...
              className="group relative bg-gradient-to-r from-green-500 via-green-600 to-emerald-600 text-white px-8 sm:px-12 py-3 sm:py-4 rounded-full font-bold text-base sm:text-lg shadow-2xl hover:shadow-green-500/30 transform hover:-translate-y-1 hover:scale-105 transition-all duration-300 overflow-hidden"
            >
              <span className="relative z-10 flex items-center justify-center">
                <svg className="w-4 h-4 sm:w-5 sm:h-5 mr-2 sm:mr-3 group-hover:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">
                ...
                <span className="hidden sm:inline">Comienza tu proceso</span>
            ...
            <button className="group bg-white/10 backdrop-blur-sm border border-white/20 text-white px-8 sm:px-12 py-3 sm:py-4 rounded-full font-bold text-base sm:text-lg hover:bg-white/20 transition-all duration-300 hover:scale-105">
              <span className="flex items-center justify-center">
                ...
                <span className="hidden sm:inline">Ver más testimonios</span>
