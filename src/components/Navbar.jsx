        ...
        createPortal(
          ...
          >
            <div
              ...
              aria-hidden="true"
            ></div>
            <div className="absolute inset-0 bg-white/95 backdrop-blur-xl shadow-2xl p-6 overflow-y-auto overscroll-contain min-h-screen">
              <div className="flex items-center justify-between pt-[max(env(safe-area-inset-top),0.5rem)] pb-4">
                <div className="flex items-center space-x-3">
                  <div className="relative w-9 h-9 bg-gradient-to-br from-blue-600 to-blue-700 rounded-full flex items-center justify-center shadow-lg">
              ...
              <div className="max-w-7xl mx-auto">
                  ...
                  {navItems.map((item) => {
                    ...
                    return (
                      <button
                        key={item.id}
                        onClick={() => scrollToSection(item.id)}
                        className={`w-full text-left px-5 py-5 rounded-2xl text-lg font-semibold transition-all duration-200 flex items-center justify-between ${
                          isActive
                            ? 'bg-gradient-to-r from-blue-600/10 to-purple-600/10 text-blue-700 border border-blue-500/20'
                            : 'bg-white/70 text-gray-800 hover:bg-blue-50 border border-gray-100'
                        }`}
                        aria-current={isActive ? 'page' : undefined}
                      >
                ...
                <a
                  href="https://wa.me/18496533224"
                  className="mt-6 block bg-gradient-to-r from-green-500 to-emerald-600 text-white px-6 py-4 rounded-2xl font-bold text-center shadow-xl hover:shadow-2xl transition-all duration-300"
                  aria-label="Contactar por WhatsApp"
                >
