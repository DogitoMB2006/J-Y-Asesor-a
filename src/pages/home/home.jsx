...
function Home() {
  return (
    <div className="min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl lg:text-6xl font-bold text-[#0B2A3D] mb-6 font-inter">
              ¿Por qué elegir <span className="text-[#0B2A3D]">J&Y Visado</span>?
            </h2>
            ...
            {services.map((service, index) => (
              ...
              >
                ...
                <div className="relative">
                  <h3 className="text-xl font-bold text-[#0B2A3D] mb-4 group-hover:text-[#0B2A3D] transition-colors duration-300">
                    {service.title}
                  </h3>
          ...
          <div className="bg-gradient-to-r from-[#0B2A3D] via-[#0D3548] to-[#0F4054] rounded-3xl p-8 lg:p-12 shadow-2xl">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
              <div className="space-y-2">
                <AnimatedCounter end={500} suffix="+" />
                <div className="text-white/70 text-sm lg:text-base">Visas Aprobadas</div>
              </div>
              <div className="space-y-2">
                <AnimatedCounter end={10} suffix="+" />
                <div className="text-white/70 text-sm lg:text-base">Años de Experiencia</div>
              </div>
              <div className="space-y-2">
                <AnimatedCounter end={95} suffix="%" />
                <div className="text-white/70 text-sm lg:text-base">Tasa de Éxito</div>
              </div>
              <div className="space-y-2">
                <div className="text-3xl lg:text-4xl font-bold text-white">24/7</div>
                <div className="text-white/70 text-sm lg:text-base">Soporte Virtual</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="quienes-somos" className="py-20 lg:py-32 bg-white relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl lg:text-6xl font-bold text-[#0B2A3D] mb-6 font-inter">
              ¿Quiénes <span className="text-[#0B2A3D]">somos</span>?
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
            <div className="space-y-8">
              <div className="space-y-6">
                <div className="bg-gradient-to-r from-white to-gray-50 rounded-3xl p-8 border border-gray-100 transform hover:scale-105 transition-transform duration-300 shadow-lg">
                  <div className="flex items-center mb-4">
                    <div className="w-12 h-12 bg-[#0B2A3D] rounded-2xl flex items-center justify-center mr-4">
                      <span className="text-white text-xl">🎯</span>
                    </div>
                    <h3 className="text-2xl font-bold text-[#0B2A3D]">Nuestra Misión</h3>
                  </div>
                ...
                <div className="bg-gradient-to-r from-white to-gray-50 rounded-3xl p-8 border border-gray-100 transform hover:scale-105 transition-transform duration-300 shadow-lg">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-2xl font-bold text-[#0B2A3D]">Nuestra Experiencia</h3>
                  </div>
                  <p className="text-gray-700 leading-relaxed text-lg">
                ...
                <div className="bg-gradient-to-r from-white to-gray-50 rounded-3xl p-8 border border-gray-100 transform hover:scale-105 transition-transform duration-300 shadow-lg">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-2xl font-bold text-[#0B2A3D]">Nuestros Resultados</h3>
                  </div>
                  <p className="text-gray-700 leading-relaxed text-lg">
              ...
              <div className="pt-8">
                <a 
                  ...
                  className="group inline-flex items-center bg-gradient-to-r from-[#0B2A3D] via-[#0D3548] to-[#0F4054] text-white px-10 py-4 rounded-full font-bold text-lg shadow-2xl hover:shadow-[#0B2A3D]/30 transform hover:-translate-y-1 hover:scale-105 transition-all duration-300"
                >
            ...
            <div className="relative">
                              <div className="absolute -inset-4 bg-gradient-to-r from-[#0B2A3D]/30 to-[#0B2A3D]/30 rounded-3xl blur-xl"></div>
              <img 
              ...
              <div className="absolute -top-6 -right-6 bg-[#0B2A3D] text-white p-4 rounded-2xl shadow-lg animate-float">
                <div className="text-2xl font-bold">DS-160</div>
                <div className="text-sm opacity-90">Especialistas</div>
              </div>
              
              <div className="absolute -bottom-6 -left-6 bg-[#0B2A3D] text-white p-4 rounded-2xl shadow-lg animate-float delay-500">
      ...
      <section className="py-20 lg:py-32 bg-gradient-to-br from-[#0B2A3D] via-[#0D3548] to-[#0F4054] relative overflow-hidden">
        {/* Background effects */}
            ...
            {processSteps.map((step, index) => (
              <div key={index} className="relative group">
                {index < processSteps.length - 1 && (
                  <div className="hidden lg:block absolute top-10 left-full w-full h-0.5 bg-gradient-to-r from-white/30 to-white/10 z-0"></div>
                )}
                
                <div className="relative bg-white/10 backdrop-blur-sm border border-white/20 rounded-3xl p-8 shadow-2xl hover:shadow-white/10 transition-all duration-500 transform hover:-translate-y-2 text-center group-hover:scale-105">
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 w-8 h-8 bg-white rounded-full flex items-center justify-center text-[#0B2A3D] text-sm font-bold shadow-lg">
                    {step.number}
                  </div>
                  
                  <div className="mb-6 mt-4">
                    <div className="w-16 h-16 mx-auto bg-white/20 backdrop-blur-sm border border-white/30 rounded-2xl flex items-center justify-center text-2xl shadow-lg group-hover:scale-110 transition-transform duration-300">
